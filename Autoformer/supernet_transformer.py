...
from Autoformer.module.Linear_super import LinearSuper
from Autoformer.module.layernorm_super import LayerNormSuper
from Autoformer.module.multihead_super import AttentionSuper
from Autoformer.module.embedding_super import PatchembedSuper
from Autoformer.utils import trunc_normal_
from Autoformer.utils import DropPath
import numpy as np
...
class Vision_TransformerSuper(nn.Module):
    ...
    def __init__(self, img_size=224, patch_size=16, in_chans=2, num_classes=1000, embed_dim=768, depth=12,
        ...
        self.scale=scale
        self.patch_embed_super = PatchembedSuper(img_size=img_size, patch_size=patch_size, kernel_size=16,
